...
#### get all menus by date(for Authenticated)
`curl 'http://localhost:8080/rest/menus?date=2020-04-01' --user 'user@yandex.ru:password'`
...
#### get all votes by date(for Authenticated)
...
`curl -s -i -X POST -H 'Content-Type:application/json;charset=UTF-8' http://localhost:8080/rest/votes/100013 --user user@yandex.ru:password`
...
`curl 'http://localhost:8080/rest/votes/admin/100025' --user admin@gmail.com:admin`

#### get all votes by user id (for Admin only)
`curl 'http://localhost:8080/rest/votes/admin/byUser/100000' --user admin@gmail.com:admin`

#### create vote (for Admin only)
`curl -s -i -X POST -d '{"date":"2020-04-02","restaurant":{"id":100014,"name":"Steak House"},"user":{"id":100001,"name":"Admin","email":"admin@gmail.com","enabled":true,"registered":"2020-05-14T07:01:05.392+00:00","roles":["USER","ADMIN"]}}' -H 'Content-Type:application/json;charset=UTF-8' http://localhost:8080/rest/votes/admin --user admin@gmail.com:admin`

#### update vote (for Admin only)
`curl -X PUT -H 'Content-Type:application/json;charset=UTF-8' -d '{"date":"2020-05-04","restaurant":{"id":100014,"name":"Steak House"},"user":{"id":100001,"name":"Admin","email":"admin@gmail.com","enabled":true,"registered":"2020-05-14T07:01:05.392+00:00","roles":["USER","ADMIN"]}}' http://localhost:8080/rest/votes/admin/100033 --user admin@gmail.com:admin`

#### delete menu (for Admin only)
`curl -X DELETE -H 'Content-Type:application/json;charset=UTF-8' http://localhost:8080/rest/votes/admin/100030  --user admin@gmail.com:admin`
