...
public class DishTestData {
    ...
    public static final Dish DISH_1 = new Dish(START_SEQ + 5, "Meat Soup", 50, LocalDate.of(2020, Month.APRIL,1), REST_1); // id:100005
    public static final Dish DISH_2 = new Dish(START_SEQ + 6, "Caesar", 50, LocalDate.of(2020, Month.APRIL,1), REST_1);
    public static final Dish DISH_3 = new Dish(START_SEQ + 7, "BeefSteak", 150, LocalDate.of(2020, Month.APRIL,1), REST_1);
    public static final Dish DISH_4 = new Dish(START_SEQ + 8, "Coffee", 15, LocalDate.of(2020, Month.APRIL,1), REST_1);

    public static final Dish DISH_5 = new Dish(START_SEQ + 9, "Chicken Soup", 40, LocalDate.of(2020, Month.APRIL,1), REST_2);
    public static final Dish DISH_6 = new Dish(START_SEQ + 10, "Salad with meat", 50, LocalDate.of(2020, Month.APRIL,1), REST_2); // id:1000
    public static final Dish DISH_7 = new Dish(START_SEQ + 11, "Fried Chicken", 110, LocalDate.of(2020, Month.APRIL,1), REST_2);
    public static final Dish DISH_8 = new Dish(START_SEQ + 12, "Tee", 10, LocalDate.of(2020, Month.APRIL,1), REST_2); // id:1000

    public static final Dish DISH_9 = new Dish(START_SEQ + 13, "Gazpacho", 30, LocalDate.of(2020, Month.APRIL,1), REST_3);
    public static final Dish DISH_10 = new Dish(START_SEQ + 14, "Vegetable salad", 40, LocalDate.of(2020, Month.APRIL,1), REST_3);
    public static final Dish DISH_11 = new Dish(START_SEQ + 15, "IceCream", 30, LocalDate.of(2020, Month.APRIL,1), REST_3);
    public static final Dish DISH_12 = new Dish(START_SEQ + 16, "Juice", 20, LocalDate.of(2020, Month.APRIL,1), REST_3);
