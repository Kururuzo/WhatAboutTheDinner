...
public class DishTestData {
    ...
    public static final Dish DISH_1 = new Dish(START_SEQ + 2, "Meat Soup", 50);
    public static final Dish DISH_2 = new Dish(START_SEQ + 3, "Chicken Soup", 40);
    public static final Dish DISH_3 = new Dish(START_SEQ + 4, "Salad with meat", 50);
    ...
    public static final Dish DISH_11 = new Dish(START_SEQ + 12, "Tee", 10);
